...
#ifndef COUETTEFIELDS_H
#define COUETTEFIELDS_H
...
/**
 * Initialize velocity fields for couette flow simulations
 *
 * This task is activated by using the `init_couette_fields` task in the
 * preprocessing input file. It requires a section `init_couette_fields` in the
 ...
 */
class CouetteFields: public PreProcessingTask
{
public:
    template<typename T>
...
private:
    CouetteFields() = delete;
    CouetteFields(const CouetteFields&) = delete;
